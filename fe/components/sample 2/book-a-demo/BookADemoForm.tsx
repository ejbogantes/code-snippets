...
export default function ContactForm({ formik, products, alertState }) {
  return (
            ...
            <FormControl
              ...
              <Select
                ...
                {products.map((opt, index) => {
                  return (
                    <MenuItem key={`selectProduct${index}`} value={opt.value}>
                      {opt.label}
                    </MenuItem>
                  );
                })}
              ...
              {formik.touched.product && Boolean(formik.errors.product) ? (
                <FormHelperText>{formik.errors.product}</FormHelperText>
              ) : null}
            </FormControl>
          </Grid>
        )}
