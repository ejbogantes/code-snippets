...
export function Content({ styles }) {
  return (
    <div>
      ...
      <p>Updated at 2023-01-03</p>

      <p>
        {' '}
        Soom (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how your
        personal information is collected, used, and disclosed by Soom.
      </p>
      <p>
        This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”)
        alongside our application, Soom. By accessing or using our Service, you signify that you have read, understand,
        and agree to our collection, storage, use, and disclosure of your personal information as described in this
        Privacy Policy and our <Link href="/terms-of-use">Terms of Service.</Link>
      </p>
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Soom, Inc, Delaware that is
            responsible for your information under this Privacy Policy.
          </li>
          <li>Country: where Soom or the owners/founders of Soom are based, in this case is United States</li>
          <li>
            Customer: refers to the company, organization or person that signs up to use the Soom Service to manage the
          ...
          <li>
            ...
            to visit Soom and use the services.
          </li>
          <li>
          ...
          <li>
            Personnel: refers to those individuals who are employed by Soom or are under contract to perform a service
          ...
          <li>
            Service: refers to the service provided by Soom as described in the relative terms (if available) and on
            this platform.
          </li>
          <li>
          ...
          <li>Website: Soom's site, which can be accessed via this URL: https://www.soom.com</li>
          <li>You: a person or entity that is registered with Soom to use the Services.</li>
        </ul>
      </p>
      ...
      <h1>When does Soom use end user information from third parties?</h1>
      <p>Soom will collect End User Data necessary to provide the Soom services to our customers.</p>
      <p>
      ...
      <h1>When does Soom use customer information from third parties?</h1>
      <p>
        We receive some information from the third parties when you contact us. For example, when you submit your email
        address to us to show interest in becoming a Soom customer, we receive information from a third party that
        provides automated fraud detection services to Soom. We also occasionally collect information that is made
      ...
      <p>
        Soom will collect personal information that you submit to us. We may also receive personal information about you
      ...
      <p>
        We keep your information only so long as we need it to provide Soom to you and fulfill the purposes described in
        this policy. This is also the case for anyone that we share your information with and who carries out services
        on our behalf. When we no longer need to use your information and there is no need for us to keep it to comply
      ...
      <p>
        ...
        ensure or warrant the absolute security of any information you transmit to Soom or guarantee that your
      ...
      <p>
        Soom is incorporated in United States. Information collected via our website, through direct interactions with
      ...
      <h1>Is the information collected through the Soom Service secure?</h1>
      <p>
      ...
      <p>
        The rights you have to request updates or corrections to the information Soom collects depend on your
        relationship with Soom. Personnel may update or correct their information as detailed in our internal company
        employment policies.
      </p>
      <p>
      ...
      <h1>Personnel</h1>
      <p>
        If you are a Soom worker or applicant, we collect information you voluntarily provide to us. We use the
      ...
      <p>
        ...
        of all or substantially all of the assets of Soom or any of its Corporate Affiliates (as defined herein), or
        that portion of Soom or any of its Corporate Affiliates to which the Service relates, or in the event that we
      ...
      <p>
        ...
        is controlled by or is under common control with Soom, whether by ownership or otherwise. Any information
      ...
      <p>
        By using Soom or contacting us directly, you signify your acceptance of this Privacy Policy. If you do not agree
      ...
      <p>
        ...
        or controlled by Soom. We are not responsible for the content, accuracy or opinions expressed in such websites,
        ...
        to that website’s own rules and policies. Such third parties may use their own cookies or other methods to
        collect information about you.
      </p>
      <h1>Cookies</h1>
      <p>
        Soom uses "Cookies" to identify the areas of our website that you have visited. A Cookie is a small piece of
      ...
      <p>
        You acknowledge and agree that Soom shall not be responsible for any Third-Party Services, including their
        accuracy, completeness, timeliness, validity, copyright compliance, legality, decency, quality or any other
        aspect thereof. Soom does not assume and shall not have any liability or responsibility to you or any other
      ...
      <ul>
        <li>
          Cookies
          <p>
            We use Cookies to enhance the performance and functionality of our $platform but are non-essential to their
            use. However, without these cookies, certain functionality like videos may become unavailable or you would
            be required to enter your login details every time you visit the $platform as we would not be able to
        ...
        <li>
          Sessions
          <p>
            Soom uses "Sessions" to identify the areas of our website that you have visited. A Session is a small piece
      ...
      <p>
        ...
        fines for breach. Beyond these facts it's simply the right thing to do. At Soom we strongly believe that your
      ...
      <p>
        We are committed to helping our customers meet the data subject rights requirements of GDPR. Soom processes or
      ...
      <ul>
        <li>Via Phone Number: +1 (617) 674-8209</li>
        <li>Via this Link: https://www.soom.com/contact</li>
      </ul>
      <br></br>
      <a href="https://www.soom.com/cms/files/Soom-Privacy-Policy-5-29-2019-GU-1132165.pdf" className={styles.anchor}>
