...
const api = axios.create({
  baseURL: process.env.UPLOAD_S3_URL
});

// TODO: Make this TypeScript file
...
export class Uploader {
  ...
  async initialize() {
    try {
      ...
      const fileInitializationUploadInput = {
        bucket: this.bucket,
        name: fileName,
        contentType: this.file.type,
        isPrivate: this.isPrivate
      };
      console.log(fileInitializationUploadInput);
      const initializeResponse = await api.request({
        url: '/api/uploads/initializeMultipartUpload',
        method: 'POST',
        data: fileInitializationUploadInput
      });
